#!/bin/bash
#SBATCH --job-name=blip
#SBATCH --account=def-wassim
#SBATCH --gres=gpu:a100_2g.10gb:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=5-00:00:00
#SBATCH --output=/scratch/ali95/blip2_blip/%x_%j.out
#SBATCH --error=/scratch/ali95/blip2_blip/%x_%j.err
...
# -------------------------
# Stability (very tight MIG)
# -------------------------
export OMP_NUM_THREADS=${SLURM_CPUS_PER_TASK}
export TOKENIZERS_PARALLELISM=false
export PYTHONUNBUFFERED=1
export TORCH_CUDA_ALLOC_CONF=max_split_size_mb:64,expandable_segments:True
